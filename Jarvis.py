...
def ChatGpt3_5(user_input):
    # Assuming the environment variable for the Gemini API key is 'GEMINI_API_KEY'
    ...
    if 'ai' in user_input and 'mode' in user_input:
        ...
        # Call the Gemini API
        model = genai.GenerativeModel('gemini-1.5-flash')  # Replace with the actual model name
